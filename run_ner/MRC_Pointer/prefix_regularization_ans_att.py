...
if __name__ == "__main__":
        ...
        path="have_ans_predict_"+str(args_.have_ans_predict)+"_"+"attention_"+str(args_.self_attention)+"_"+args_.loss_type+"_"+args_.model_dataset+"_"+str(args_.seed)+"__"+str(args_.prefix_seq_len)
