...
if __name__ == '__main__':
    ...
    from Code.run_ner.MRC_EG_G_Set_Config import bert_efficient_globalpointer_config
    args = bert_efficient_globalpointer_config()
    ...
    from Code.models.global_method import Encoder_Bert
    encoder = Encoder_Bert(args.model_name_or_path[0])  # 用bert作为encoder
