...
from Code.models.global_method import DataMaker, MyDataset, GlobalPointer, MetricsCalculator,EfficientGlobalPointer,Encoder_Bert_prefix
...
if __name__ == '__main__':
    ...
    from Code.run_ner.MRC_EG_G_Set_Config import bert_prefix_efficient_globalpointer_config
    args = bert_prefix_efficient_globalpointer_config()
    ...
    encoder = Encoder_Bert_prefix(args.model_name_or_path[0])  # 用bert+prefix作为encoder regularization_GlobalPointer_config use_prefix设置为True
    model = EfficientGlobalPointer(encoder, args.ent_type_size, 64)  # GlobalPointer模型
