...
from Code.models.global_method import DataMaker, MyDataset, GlobalPointer, MetricsCalculator,EfficientGlobalPointer,Encoder_Bert_prefix,create_bert_prefix_GlobalPointer_regularization,create_bert_prefix_EfficientGlobalPointer_regularization
...
if __name__ == '__main__':
    ...
    args = bert_prefix_efficient_GlobalPointer_regularization_config()
    ...
    model = create_bert_prefix_EfficientGlobalPointer_regularization(args)
